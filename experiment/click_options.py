...
click.option('--algorithm', default='src.chac', help='the name of the algorithm to be used',
...
click.option('--early_stop_threshold', type=float, default=100, help='The early stopping threshold.'),
