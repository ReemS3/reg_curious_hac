#For MuJoCo
export MUJOCO_PY_MUJOCO_PATH=/data/$(whoami)/mujoco20
export MUJOCO_PY_MJKEY_PATH=/data/mujoco20/bin/mjkey.txt
export LD_LIBRARY_PATH=/data/mujoco20/mjkey.txt
