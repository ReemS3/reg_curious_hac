...
# TODO: Check what options we need 
chac_options = [
...
click.option('--fw_hidden_size', type=str, default='256,256,256', help='Size for each hidden layer of the forward model'),
...
# For regularization
click.option('--regularization', type=bool, help='Enable regularization of the subgoal representation')
]
