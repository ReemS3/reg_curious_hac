    ...
    for gripper_goal in ['gripper_random', 'gripper_above', 'gripper_none']:
        ...
        for idep in IDsAndEPs:
            register(
                ...
                entry_point='mujoco.blocks.' + idep[1] + idep[0],
                kwargs=kwargs,
...
for n_objects in range(0, 5):
    ...
    register(
        ...
        entry_point='mujoco.causal_dep.unlock_goal:CausalDependenciesMujocoEnv',
        kwargs=kwargs,
        max_episode_steps=max_ep_steps)
...
for n_objects in range(0, 5):
    for gripper_goal in ['gripper_random', 'gripper_above', 'gripper_none']:
        ...
        register(
            ...
            entry_point='mujoco.keybot.stack_blocks:KeybotBlockStackMujocoEnv',
            kwargs=kwargs,
            max_episode_steps=max_ep_steps,
        )
...
for n_objects in range(0, 5):
    for gripper_goal in ['gripper_random', 'gripper_above', 'gripper_none']:
        ...
        register(
            ...
            entry_point='mujoco.jarvisbot.stack_blocks:JarvisbotBlockStackMujocoEnv',
            kwargs=kwargs,
            max_episode_steps=max_ep_steps,
        )
...
for n_objects in range(0, 5):
    for gripper_goal in ['gripper_random', 'gripper_above', 'gripper_none']:
        ...
        register(
            ...
            entry_point='mujoco.nicobot.stack_blocks:NicobotBlockStackMujocoEnv',
            kwargs=kwargs,
            max_episode_steps=max_ep_steps,
        )
...
for n_objects in range(0, 5):
    for gripper_goal in ['gripper_random', 'gripper_above', 'gripper_none']:
        ...
        register(
            ...
            entry_point='mujoco.rocker.press_grasp:RockerMujocoEnv',
            kwargs=kwargs,
            max_episode_steps=max_ep_steps,
        )
...
for gripper_goal in ['gripper_random', 'gripper_above', 'gripper_none']:
    for easy in range(2):
        ...
        register(
            ...
            entry_point='mujoco.hook.pull_object:HookMujocoEnv',
            kwargs=kwargs,
            max_episode_steps=max_ep_steps,
        )
...
register(id='AntFourRoomsEnv-v0',
         entry_point='mujoco.ant_four_rooms.navigate:AntFourRoomsEnv',
         max_episode_steps=max_ep_steps)

register(id='AntReacherEnv-v0',
         entry_point='mujoco.ant_reacher.reach:AntReacherEnv',
         max_episode_steps=max_ep_steps)
...
for obs_type in range(0, 4):
    ...
    register(id='UR5ReacherEnv-v{}'.format(kwargs['obs_type']),
             entry_point='mujoco.ur5.reaching:Ur5ReacherEnv',
             kwargs=kwargs,
